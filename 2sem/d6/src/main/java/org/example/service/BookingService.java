...
public class BookingService {
    ...
    public BookingCreateResponse createBooking(BookingCreateRequest req) {
        ...
        jdbc.update(
                "update bookings.bookings set total_amount = ? where book_ref = ?",
                total,
                bookRef
        );
    ...
    public CheckinResponse checkin(CheckinRequest req) {
        ...
        if (ticketNo == null) {
            throw new IllegalArgumentException("Booking/flight not found");
        }
    ...
    private int parseFlightId(String flightNo) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "flightNo must be numeric (flight_id in demo DB)"
            );
        }
    }
